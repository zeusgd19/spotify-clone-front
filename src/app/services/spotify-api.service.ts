...
export class SpotifyApiService {
  private apiUrl = 'spotifyclone.vps.webdock.cloud/api'; // Your Symfony backend URL
  private authUrl = 'spotifyclone.vps.webdock.cloud'; // Your Symfony backend URL for auth
  ...
  refreshToken(): Observable<any> {
    ...
    return this.http.post('spotifyclone.vps.webdock.cloud/api/token/refresh',body);
  }
