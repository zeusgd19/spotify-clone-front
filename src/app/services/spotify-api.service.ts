...
export class SpotifyApiService {
  private apiUrl = 'http://spotifyclone.vps.webdock.cloud/api'; // Your Symfony backend URL
  private authUrl = 'http://spotifyclone.vps.webdock.cloud'; // Your Symfony backend URL for auth
  ...
  refreshToken(): Observable<any> {
    ...
    return this.http.post('http://spotifyclone.vps.webdock.cloud/api/token/refresh',body);
  }
